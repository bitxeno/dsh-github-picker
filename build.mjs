/**
 * Single-file client + ESM host build for dsh-github-picker.
 *
 * The web server serves exactly one file per plugin (/plugins/dsh-github-picker/client.js),
...
await build({
  ...
  banner: {
    js: "window.__ModuleLoader__.load({ id: 'dsh-github-picker', factory: (require) => { var module = { exports: {} }; var exports = module.exports;",
  },
  footer: {
